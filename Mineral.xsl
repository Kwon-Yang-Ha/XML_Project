    ...
    <html>
      ...
      <body style="background-color:fff584">
        ...
        <div class="row1 w3-display-container w3-content" style="max-width:100%">
          <img class="w3-image" src="image/Mineral.jpg" alt="title" width="100%" height="25" />
          <div class="w3-display-middle xlarge  w3-wide w3-text-white">
            <h1 class="w3-hide-small w3-xxxlarge"></h1>
            <h1 class="w3-hide-medium w3-hide-small">Mineral</h1>
          </div>
        </div>
        <div id="cont0">
          <p id="p1">무기질 영양성분이 많은 건강식품</p>
          <p id="line" />
          <p id="p2">Frist</p>
        </div>
        <div class="sh">
          ...
          <div class="firstslideshow">
            <div class="firstslide">
              ...
              <div class="slide s1">
                <div class="simg">
                  <img src="image/우유.jpg" width="500" height="50" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='우유']/name" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    ...
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='우유']/description" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide s2">
                ...
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='우유']/effect" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide s3">
                <div class="simg">
                  <img src="image/복부팽만.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='우유']/damage" />
                    </p>
                    <br />
                  </div>
                </div>
        ...
        <div class="sh">
          ...
          <div class="secondslideshow">
            <div class="secondslide">
              ...
              <div class="bslide i1">
                <div class="bsimg">
                  <img src="image/버섯.jpg" />
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='버섯']/name" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    <p id="fillt">Description</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='버섯']/description" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="bslide i2">
                <div class="bsimg">
                  <img src="image/면역력.jpg" />
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='버섯']/effect" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="bslide i3">
                <div class="bsimg">
                  <img src="image/피부발진.jpg" />
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='버섯']/damage" />
                    </p>
                    <br />
                  </div>
                </div>
        ...
        <div class="sh">
          ...
          <div class="thirdslideshow">
            <div class="thirdslide">
              ...
              <div class="slide f1">
                <div class="simg">
                  <img src="image/시금치.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='시금치']/name" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    <p id="fillt">Description</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='시금치']/description" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide f2">
                ...
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='시금치']/effect" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide f3">
                <div class="simg">
                  <img src="image/신장결석.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Mineral/food[@kind='시금치']/damage" />
                    </p>
                    <br />
                  </div>
                </div>
