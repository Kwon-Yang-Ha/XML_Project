    ...
    <html>
      ...
      <body style="background-color:fff584">
        ...
        <div class="row1 w3-display-container w3-content" style="max-width:100%">
          <img class="w3-image" src="image/Fat.jpg" alt="title" width="100%" height="25%" />
          <div class="w3-display-middle xlarge  w3-wide w3-text-black">
            <h1 class="w3-hide-small w3-xxxlarge"></h1>
            <h1 class="w3-hide-medium w3-hide-small">Fat</h1>
          </div>
        </div>
        <div id="cont0">
          <p id="p1">지방 영양성분이 많은 건강식품</p>
          <p id="line"></p>
          <p id="p2">First</p>
        </div>
        <div class="sh">
          ...
          <div class="firstslideshow">
            <div class="firstslide">
              ...
              <div class="slide s1">
                <div class="simg">
                  <img src="image/아보카도.jpg"></img>
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='아보카도']/name" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    ...
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='아보카도']/description" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide s2">
                <div class="simg">
                  <img src="image/눈.jpg"></img>
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='아보카도']/effect" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide s3">
                <div class="simg">
                  <img src="image/복통.jpg"></img>
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='아보카도']/damage" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                </div>
        ...
        <div class="sh">
          <div class="bnav">
            <label for="b1" class="bbar"></label>
            <label for="b2" class="bbar"></label>
            <label for="b3" class="bbar"></label>
          </div>
          <div class="secondslideshow">
            <div class="secondslide">
              ...
              <div class="bslide i1">
                <div class="bsimg">
                  <img src="image/견과류.jpg"></img>
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='견과류']/name" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    <p id="fillt">Description</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='견과류']/description" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="bslide i2">
                <div class="bsimg">
                  <img src="image/아이학습.jpg"></img>
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='견과류']/effect" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="bslide i3">
                <div class="bsimg">
                  <img src="image/설사.jpg"></img>
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='견과류']/damage" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                </div>
        ...
        <div class="sh">
          <div class="fnav">
            <label for="f9" class="fbar"></label>
            <label for="f10" class="fbar"></label>
            <label for="f11" class="fbar"></label>
          </div>
          <div class="thirdslideshow">
            <div class="thirdslide">
              ...
              <div class="slide f1">
                <div class="simg">
                  <img src="image/올리브오일.jpg"></img>
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='올리브 오일']/name" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    <p id="fillt">Description</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='올리브 오일']/description" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide f2">
                <div class="simg">
                  <img src="image/관절염.jpg"></img>
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='올리브 오일']/effect" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide f3">
                <div class="simg">
                  <img src="image/가려움.jpg"></img>
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of select="components/Fat/food[@kind='올리브 오일']/damage" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" />
                    </p>
                    <br />
                  </div>
                </div>
