    ...
    <html>
      ...
      <body style="background-color:fff584">
        ...
        <div class="row1 w3-display-container w3-content" style="max-width:100%">
          <img class="w3-image" src="image/Protein.jpg" alt="title" width="100%" height="25%" />
          <div class="w3-display-middle xlarge  w3-wide w3-text-white">
            <h1 class="w3-hide-small w3-xxxlarge"></h1>
            <h1 class="w3-hide-medium w3-hide-small">Protein</h1>
          </div>
        </div>
        <div id="cont0">
          <p id="p1">단백질 영양성분이 많은 건강식품</p>
          <p id="line" />
          <p id="p2">Frist</p>
        </div>
        <div class="sh">
          ...
          <div class="firstslideshow">
            <div class="firstslide">
              ...
              <div class="slide s1">
                <div class="simg">
                  <img src="image/달걀.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='달걀']/name" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    ...
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='달걀']/description" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide s2">
                ...
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='달걀']/effect" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide s3">
                <div class="simg">
                  <img src="image/아토피.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='달걀']/damage" />
                    </p>
                    <br />
                  </div>
                </div>
        ...
        <div class="sh">
          ...
          <div class="secondslideshow">
            <div class="secondslide">
              ...
              <div class="bslide i1">
                <div class="bsimg">
                  <img src="image/닭가슴살.jpg" />
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='닭가슴살']/name" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    <p id="fillt">Description</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='닭가슴살']/description" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="bslide i2">
                ...
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='닭가슴살']/effect" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="bslide i3">
                <div class="bsimg">
                  <img src="image/통풍.jpg" />
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='닭가슴살']/damage" />
                    </p>
                    <br />
                  </div>
                </div>
        ...
        <div class="sh">
          ...
          <div class="thirdslideshow">
            <div class="thirdslide">
              ...
              <div class="slide f1">
                <div class="simg">
                  <img src="image/고등어.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='고등어']/name" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    <p id="fillt">Description</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='고등어']/description" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide f2">
                <div class="simg">
                  <img src="image/두뇌.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='고등어']/effect" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide f3">
                <div class="simg">
                  <img src="image/소금.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Protein/food[@kind='고등어']/damage" />
                    </p>
                    <br />
                  </div>
                </div>
