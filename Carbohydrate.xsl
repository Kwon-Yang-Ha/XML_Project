    ...
    <html>
      ...
      <body style="background-color:fff584">
        ...
        <div class="row1 w3-display-container w3-content" style="max-width:100%">
          <img class="w3-image" src="image/Carbohydrate.jpg" alt="title" width="100%" height="25%" />
          <div class="w3-display-middle xlarge  w3-wide w3-text-white">
            <h1 class="w3-hide-small w3-xxxlarge"></h1>
            <h1 class="w3-hide-medium w3-hide-small">Carbohydrate</h1>
          </div>
        </div>
        <div id="cont0">
          <p id="p1">탄수화물 영양성분이 많은 건강식품</p>
          <p id="line" />
          <p id="p2">Frist</p>
        </div>
        <div class="sh">
          ...
          <div class="firstslideshow">
            <div class="firstslide">
              ...
              <div class="slide s1">
                <div class="simg">
                  <img src="image/퀴노아.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='퀴노아']/name" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    ...
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='퀴노아']/description" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide s2">
                ...
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='퀴노아']/effect" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide s3">
                <div class="simg">
                  <img src="image/구루병.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='퀴노아']/damage" />
                    </p>
                    <br />
                  </div>
                </div>
        ...
        <div class="sh">
          ...
          <div class="secondslideshow">
            <div class="secondslide">
              ...
              <div class="bslide i1">
                <div class="bsimg">
                  <img src="image/바나나.png" />
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='바나나']/name" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    <p id="fillt">Description</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='바나나']/description" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="bslide i2">
                <div class="bsimg">
                  <img src="image/혈관.jpg" />
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='바나나']/effect" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="bslide i3">
                <div class="bsimg">
                  <img src="image/복통.jpg" />
                </div>
                <div class="bstxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='바나나']/damage" />
                    </p>
                    <br />
                  </div>
                </div>
        ...
        <div class="sh">
          ...
          <div class="thirdslideshow">
            <div class="thirdslide">
              ...
              <div class="slide f1">
                <div class="simg">
                  <img src="image/비트뿌리.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Name</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='비트 뿌리']/name" />
                    </p>
                    <br />
                  </div>
                  <div class="tclick">
                    <p id="fillt">Description</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='비트 뿌리']/description" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide f2">
                <div class="simg">
                  <img src="image/혈관_2.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Effect</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='비트 뿌리']/effect" />
                    </p>
                    <br />
                  </div>
                </div>
              ...
              <div class="slide f3">
                <div class="simg">
                  <img src="image/신장.jpg" />
                </div>
                <div class="stxt">
                  <div class="tclick">
                    <p id="fillt">Damage</p>
                    <p id="fillt2">
                      <xsl:value-of xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="components/Carbohydrate/food[@kind='비트 뿌리']/damage" />
                    </p>
                    <br />
                  </div>
                </div>
